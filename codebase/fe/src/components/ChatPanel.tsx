  ...
  return (
    <aside className="flex min-h-0 flex-col bg-white">
      ...
      <div className="flex min-h-0 flex-1 flex-col p-4">
        <section className="flex min-h-0 flex-1 flex-col rounded-[1.75rem] border border-slate-200 bg-slate-50">
          <div className="flex items-center gap-2 border-b border-slate-200 px-4 py-3 text-sm font-medium text-slate-700">
            <MessageSquareText className="h-4 w-4" />
            Trò chuyện
          </div>
          <div className="trace-scrollbar flex min-h-0 flex-1 flex-col gap-4 overflow-y-auto p-4">
            <div className="rounded-[1.75rem] border border-amber-100 bg-[radial-gradient(circle_at_top_right,_rgba(251,191,36,0.18),_transparent_38%),_#fffdf8] p-5">
              ...
              <p className="mt-2 text-sm leading-6 text-slate-600">
                Bạn có thể bôi đen văn bản từ PDF hoặc đính kèm ảnh và tệp trực tiếp vào khung
                chat. Tất cả attachment sẽ nằm ngay trong composer cho tới khi bạn xóa hoặc gửi.
              </p>
            </div>
